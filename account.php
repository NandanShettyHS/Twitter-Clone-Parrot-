        ...
        <div class="sidebar-left">
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align position-relative">
              ...
              <?php } ?>
              <img src="includes/icons/tweetnotif.png"  alt="" height="26.25px" width="26.25px"/>
            </div>
          ...
          <div class="grid-sidebar ">
            ...
            <div class="wrapper-left-elements">
              <a class="wrapper-left-active" href="/Parrot/account.php" style="margin-top: 4px"><strong>Settings</strong></a>
            </div>
