...
<head>
    ...
    <title> <?php echo $profileData->name; ?> (@<?php echo $profileData->username; ?>) Profile| Parrot</title>
    <link rel="stylesheet" href="assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/css/all.min.css">
    <link rel="stylesheet" href="assets/css/profile_style.css?v=<?php echo time(); ?>">
  
    <link rel="shortcut icon" type="image/png" href="images&logo/logo.jpg"> 
        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="https://media.istockphoto.com/id/1419501911/photo/parrot.jpg?b=1&s=170667a&w=0&k=20&c=pEAhUce_rfHMMUihGWVb5wa4nj9yHuKH3ByzUsDvKEA=" alt="" height="30px" width="30px" />
            </div>
          </div>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align position-relative">
              ...
              <?php } ?>
              <img
                src="includes/icons/tweetnotif.png" alt="" height="26.25px" width="26.25px"/>
            </div>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align">
              <img src="includes/icons/tweetprof.png" alt="" height="26.25px" width="26.25px" />
            </div>
  
            <div class="wrapper-left-elements">
              <a href="/Parrot/<?php echo $user->username; ?>"  style="margin-top: 4px"><strong>Profile</strong></a>
          ...
          <div class="grid-sidebar ">
            <div class="icon-sidebar-align">
              <img src="includes/icons/tweetsetting.png" alt="" height="26.25px" width="26.25px" />
            </div>
  
            <div class="wrapper-left-elements">
              <a href="/Parrot/account.php" style="margin-top: 4px"><strong>Settings</strong></a>
            </div>
          ...
          <div class="box-user">
            <div class="grid-user">
              ...
              <div class="mt-arrow">
                <img
                  src="https://i.ibb.co/mRLLwdW/arrow-down.png" alt=""/>       
                 </div>
            </div>
          </div>
        </div>
